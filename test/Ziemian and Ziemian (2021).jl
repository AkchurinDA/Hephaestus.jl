@testset "Frame #01" begin
    ...
    @test getnodaldisplacements(model, solution,  2) ≈ [0.0000e+00,  0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,  0.0000e+00] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  3) ≈ [8.8550e-02, -2.6579e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -3.6521e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  4) ≈ [8.6543e-02, -2.7497e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -3.5681e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  5) ≈ [3.0317e-01, -5.3158e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -5.6032e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  6) ≈ [2.9609e-01, -5.4994e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -5.4667e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  7) ≈ [5.6733e-01, -7.9737e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -5.8535e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  8) ≈ [5.5350e-01, -8.2491e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -5.6958e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  9) ≈ [8.0447e-01, -1.0632e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00, -4.4028e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 10) ≈ [7.9927e-01, -2.5797e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00,  4.9284e-04] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 11) ≈ [7.9407e-01, -1.1478e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00,  2.1493e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 12) ≈ [7.8887e-01,  3.1722e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  5.6651e-04] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 13) ≈ [7.8367e-01, -1.0999e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00, -4.2555e-03] rtol = 1E-3
...
@testset "Frame #05" begin
    ...
    @test getnodaldisplacements(model, solution,  2) ≈ [ 0.0000e+00,  0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,  8.6070e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  3) ≈ [ 0.0000e+00,  0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.3185e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  4) ≈ [-5.1719e-01, -8.2521e-03, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.3923e-02] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  5) ≈ [-3.0066e-01, -1.0652e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  7.8412e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  6) ≈ [-5.4774e-02, -5.4379e-03, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.9275e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  7) ≈ [-9.8654e-01, -1.6504e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.1930e-02] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  8) ≈ [-5.4619e-01, -2.1304e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  5.5439e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution,  9) ≈ [-1.5340e-01, -1.0876e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  3.7545e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 10) ≈ [-1.3602e+00, -2.4756e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  8.6073e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 11) ≈ [-6.8144e-01, -3.1956e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.7149e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 12) ≈ [-3.3972e-01, -1.6314e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  6.7996e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 13) ≈ [-1.5903e+00, -3.3008e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  3.9558e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 14) ≈ [-6.5128e-01, -4.2609e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -3.6457e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 15) ≈ [-6.5286e-01, -4.6883e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00, -9.1366e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 16) ≈ [-6.5443e-01, -7.9684e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00, -1.7094e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 17) ≈ [-6.5601e-01, -6.0469e-01, 0.0000e+00, 0.0000e+00, 0.0000e+00,  8.4267e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 18) ≈ [-6.5758e-01, -2.1751e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.1063e-02] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 19) ≈ [-1.6404e+00, -3.8510e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.1642e-04] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 20) ≈ [-6.1419e-01, -4.6471e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  5.8395e-04] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 21) ≈ [-1.5912e+00, -4.4011e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -4.3136e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 22) ≈ [-6.8071e-01, -5.0333e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  4.9883e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 23) ≈ [-1.4286e+00, -4.9513e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -9.3344e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 24) ≈ [-8.5503e-01, -5.4195e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  9.5673e-03] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 25) ≈ [-1.1384e+00, -5.5014e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00, -1.4946e-02] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 26) ≈ [-1.1391e+00, -1.0918e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, -1.1691e-02] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 27) ≈ [-1.1399e+00, -1.5327e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.4031e-04] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 28) ≈ [-1.1406e+00, -1.0770e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.1745e-02] rtol = 1E-3
    @test getnodaldisplacements(model, solution, 29) ≈ [-1.1413e+00, -5.8057e-02, 0.0000e+00, 0.0000e+00, 0.0000e+00,  1.4321e-02] rtol = 1E-3
