...
struct DistributedLoad{T <: Real}
    ...
    ID ::Int
    "Distributed load acting along the local ``x``-direction of the element"
    w_x::T
    "Distributed load acting along the local ``y``-direction of the element"
    w_y::T
    "Distributed load acting along the local ``z``-direction of the element"
    w_z::T
