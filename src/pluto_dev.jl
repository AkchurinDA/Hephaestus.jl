...
# ╔═╡ 265f9490-804d-11ef-0e2e-cd4abcb36d64
using PlutoDevMacros, CairoMakie

# ╔═╡ a835c910-f7f8-4c22-bb65-42fa6c8c18b3
using PlutoUI

# ╔═╡ 962be8cc-5a8d-493a-b92b-d32f0d21a4b9
# ╠═╡ show_logs = false
@fromparent import *

# ╔═╡ 01b92248-ab87-4dd1-92fb-cc733e51bd74
md"# Cantilever Beam - Concentrated Loading"

# ╔═╡ 19be9174-7f89-452d-aec6-0c2a78ca1122
md"## Create Model"

# ╔═╡ 00f17528-59ee-45d2-9a74-0aac4f795276
md"### Init Model"

# ╔═╡ 2c4e432d-8b04-4e68-a6e1-a49bd1dc702f
M = Model()

# ╔═╡ a2085d58-5f7f-4b1a-a4db-c601b9349581
md"### Add Nodes"

# ╔═╡ 1f98a60d-56de-44ab-b2fe-729cac71ae3c
begin
...
# ╔═╡ 9aa3f63a-b178-4e43-8696-71496d3dc776
md"### Add Material and Section"

# ╔═╡ 3e26a1f1-7cb3-41ed-be7b-dcefc40570dc
begin
	add_material!(M, 1, 29000, 0.3, 0.000284)
	add_section!(M, 1, 5, 1000, 1000, 10)
end

# ╔═╡ d8783ba2-1de1-43fc-96c0-cce0fa245071
md"### Add Elements"

# ╔═╡ b38f4960-b631-496b-a3e6-1ec80363dc4b
begin
...
# ╔═╡ 12066955-111f-4ad0-b593-6786ce65b5e2
md"### Add Supports"

# ╔═╡ afe7bf63-f2a1-43fb-845b-d45f30c57560
begin
...
# ╔═╡ 562b355a-b58a-473d-bd49-b65f38f3b3a0
md"### Add Loads"

# ╔═╡ d02871d5-388e-4d57-95be-57cc7044d329
begin
	add_conc_load!(M, 11, 0, -1000, 0, 0, 0, 0)
end

# ╔═╡ 897f77d9-9d1d-41b1-8c17-99e1b60a3ed0
md"## Solution"

# ╔═╡ f10c0982-c1af-4c02-b8f4-9a53ceac8b8e
Solution = solve(M, O1EAnalysis())

# ╔═╡ 2c99c026-c58a-4790-ba14-53506220e1e4
plotmodel(M)
...
manifest_format = "2.0"
project_hash = "3ef0032140b818c2d1f4fadd79d6fdf355c9f22e"
